	...
	return (
		...
		<Container fluid className="aboutAnimation wrapper close-notification aboutContainer pt-5">
            ...
            className="resume fade-in-up-on-scroll ps-3 pe-3 ms-2">
                ...
                <Link to={"https://www.dropbox.com/scl/fi/3vfmcit0575xutwa45yn3/Yevhenii-Airapetian-Lebenslauf-DE.pdf?rlkey=2g49pvsn6m1jr95ptodhplaix&st=0is6y6at&dl=0?3325"} title={t("aboutCvDeTitle")} className="download-de" target="_blank" download="Yevhenii-Airapetian-DE.pdf">
