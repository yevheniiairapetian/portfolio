...
<>
      ...
      {currentTableData.map(item => (
        <div  key={item.id}>
          ...
          {visible && <div className="notification"><div><div className="close-notification-container"><span title={t("notificationCloseTitle")} onClick={() => setVisible(!visible)} className="notification-more text-primary"></span></div></div><div className="new-info">{t("whatsNewInfo")}</div>
