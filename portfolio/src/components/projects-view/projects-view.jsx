...
<div className="app-container" onclick="hideMenu(); closeSidebar(); closeMenuDownloadLinks()">
                <h1 className="projects-main-heading mb-4">Projects</h1>
                <p className="projects-overview-paragraph">Here you will find the current web development projects that I completed
                and worked on. All of them have hyperlinks to the codebase and the project cases, most have a link to
                the deployed version, and some also have additional links.</p>
                <Image className="projects-image" src={projectsPicture} alt="An image showing a team working" />


                <p className="slider-overview-paragraph center fade-in-up-on-scroll">Use the slider controls to click through the projects list.</p>
